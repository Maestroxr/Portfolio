...
namespace Portfolio.EndlessRunner.Server
{
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.CoinClaim().ToSql(),
    ...
    {
        public global::SpacetimeDB.Table<CoinClaim, CoinClaimCols, CoinClaimIxCols> CoinClaim() => new("coin_claim", new CoinClaimCols("coin_claim"), new CoinClaimIxCols("coin_claim"));
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch
            {
                ...
                Reducer.FinishRun args => Reducers.InvokeFinishRun(eventContext, args),
