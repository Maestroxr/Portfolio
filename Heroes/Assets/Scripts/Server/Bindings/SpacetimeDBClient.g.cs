...
namespace Portfolio.Heroes.Server
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(HeroesSeat = new(conn));
            AddTable(HeroesStats = new(conn));
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.HeroesSeat().ToSql(),
            new QueryBuilder().From.HeroesStats().ToSql(),
    ...
    {
        public global::SpacetimeDB.Table<HeroesSeat, HeroesSeatCols, HeroesSeatIxCols> HeroesSeat() => new("heroes_seat", new HeroesSeatCols("heroes_seat"), new HeroesSeatIxCols("heroes_seat"));
        public global::SpacetimeDB.Table<HeroesStats, HeroesStatsCols, HeroesStatsIxCols> HeroesStats() => new("heroes_stats", new HeroesStatsCols("heroes_stats"), new HeroesStatsIxCols("heroes_stats"));
